    ...
    function addSteps(stepsNumber, imageId, stepsFolder) {
        ...
        for (var i = 1; i <= stepsNumber; i++) {
            (function (x) {
                ...
                var className = i == stepsNumber ? "selected-btn" : "Step " + x;
                var $step = $('<span class="' + className + 'inline-block px-3 py-2 mr-2 text-base rounded-xl font-semibold bg-gray-500">' + stepName + '</span>');
                $step.click(function () {
